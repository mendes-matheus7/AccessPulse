...
if(strlen($_POST['cpf']) == 0) {
    ...
    $sql_code = "SELECT * FROM membro WHERE cpf = '$cpf' AND senha = '$password'";
    ...
    if($quantidade == 1) {
        ...
        $_SESSION['user_planoID'] = $usuario['plano_idplano'];
        $_SESSION['user_level'] = "membro";
...
<body>
    <div class="grid-container-login">
        ...
        <div class="login">
            ...
            <div class="footer">
                <a href="signinfunc.php"><i class="fa-solid fa-toolbox"></i> Área do funcionário</a>
            </div>
        </div>
    </div>
</body>
